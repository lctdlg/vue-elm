<template>
  <div class="footer">
    <div class="container">
      <div class="h1">Ready to transform your brokerage operations?</div>
      <div class="h2">Our team will present the solution,demonstrate demo-cases, provide a commercial offer</div>
      <SmallInput />
      <div class="footer-info">
        <div class="footer-info-top">
          <div class="footer-info-top-des">
            <div class="logo">
              <img src="../../../assets/haame-logo.png" alt="" />
            </div>
            <p>
          ...
          <div class="footer-info-top-solutions">
            <div class="p1">Solutions</div>
            <div class="p2">Brokerages</div>
            <div class="p3">Exchange</div>
            <div class="p4">Asset Management</div>
          </div>
          <div class="footer-info-top-products">
            <div class="p1">Products</div>
            <div class="p2">CRM</div>
            <div class="p3">PAMM</div>
            <div class="p4">CopyTrading</div>
          </div>
          <div class="footer-info-top-links">
            <div class="p1">Links</div>
            <div class="p2">Insights</div>
            <div class="p3">Event</div>
            <div class="p3">About</div>
          </div>
        </div>
        <div class="footer-info-bottom">
          <div class="left">Copyright © HAAME TECH LIMITED 2024. All Rights Reserved</div>
          <div class="right">
...
<script>
import SmallInput from './small-input.vue'
// import ContainerWrap from '@/views/hamme/common/container-wrap.vue'
...
.footer {
  ...
  height: 930px;
  margin: 0 auto;
  background-image: url('../../../assets/页尾背景.png');
...
.bg1 {
  position: absolute;
  top: 0;
  left: calc(646px + 36px);
  width: 462px;
  height: 406px;
  /* background-color: red; */
  background-image: url('../../../assets/logo-立体效果-1.png');
  background-repeat: no-repeat;
...
.bg2 {
  ...
  width: 90px;
  height: 120px;
  background-image: url('../../../assets/logo-立体效果-2.png');
  background-repeat: no-repeat;
  background-position: center;
  background-size: cover;
}
.bg3 {
  ...
  width: 64px;
  height: 98px;
  background-image: url('../../../assets/logo-立体效果-3.png');
  background-repeat: no-repeat;
  background-position: center;
  background-size: cover;
}
.bg4 {
  position: absolute;
  top: 466px;
  left: calc(418px + 496px);
  width: 64px;
  height: 56px;
  background-image: url('../../../assets/logo-立体效果-4.png');
  background-repeat: no-repeat;
  background-position: center;
  background-size: cover;
}
.bg5 {
  position: absolute;
  top: 250px;
  left: calc(532px + 620px);
  width: 44px;
  height: 72px;
  background-image: url('../../../assets/logo-立体效果-5.png');
  background-repeat: no-repeat;
  background-position: center;
  background-size: cover;
}
...
.footer-info-top .footer-info-top-des {
  flex: 0 0 296px;
  width: 296px;
}
.footer-info-top .footer-info-top-des .logo {
  width: 112px;
  height: 28px;
  margin-bottom: 12px;
}
...
.footer-info-top .footer-info-top-des p {
  font-weight: 400;
  font-size: 14px;
  color: #656b8a;
  line-height: 24px;
...
.footer-info-top .footer-info-top-products,
.footer-info-top .footer-info-top-solutions,
.footer-info-top .footer-info-top-links {
  flex: 1;
  text-align: left;
}
.footer-info-top .footer-info-top-solutions {
